...
export async function sendMessage(input, messages) {
  ...
  try {
    const completion = await openai.chat.completions.create({
      ...
      messages: [
        { role: "system", content: "Respond in a clear and structured format. When ask who are you, answer: I am an AI-powered chatbot created by Francis Abainza, Jucel Barruga, Alexa Buenaflor, Christian Ebero, Cathleen Librada, and Zamantha Manalo for their school project in Data Structures and Algorithms." }, // A message, used to change how the API answers
